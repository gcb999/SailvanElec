...
//                                                       initWithRootViewController:homeCtrl];
//        
...
//                                                        initWithRootViewController:AccountCtrl];
//        
//        AccountViewController *AccountCtrl1 = [[AccountViewController alloc] init];
//        UIViewController *fourthNavigationController1 = [[CYLBaseNavigationController alloc]
//                                                        initWithRootViewController:AccountCtrl];
//        
//        /*
...
- (void)setUpTabBarItemsAttributesForController:(CYLTabBarController *)tabBarController {
    ...
    NSDictionary *dict2 = @{
                            ...
                            CYLTabBarItemImage : @"account_highlight",
