//
//  BaseProductCollectionCellFrameModel.h
//  SailvanElec
//
...
@interface JSBaseProductCollectionCellFrameModel : NSObject
...
@property(nonatomic,strong)JSBaseProductCollectionCellModel *baseModel;
